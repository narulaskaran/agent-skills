...
Example failure: `"<name> postcard"` (19 chars) → ❌
Example success: `"PostalForm 4x6 Ghibli-style postcard for <name> mailed to <address>. Part of batch of 4 cards for friends."` (143 chars) → ✅
